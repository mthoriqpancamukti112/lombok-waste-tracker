...
export default function KalingMap({
    ...
    useEffect(() => {
        ...
        // Inisialisasi awal (Default ke Mataram)
        map.current = new mapboxgl.Map({
            container: mapContainer.current,
            style: "mapbox://styles/mapbox/streets-v12",
            center: [116.1165, -8.5833],
            zoom: 11, // Mulai dari zoom jauh dulu
            pitch: 45,
        });

        map.current.addControl(new mapboxgl.NavigationControl(), "top-right");

        // Tunggu peta selesai dimuat (style loaded) sebelum menambahkan marker
        map.current.on("load", () => {
            renderMarkers("semua");

            // ==========================================
            // LOGIKA AUTO-CENTER / AUTO-ZOOM WILAYAH
            // ==========================================
            if (reports.length > 0) {
                ...
                // UBAH BAGIAN INI: Tambahkan pitch dan bearing
    ...
    }, [mapboxToken, namaWilayah]); // Jangan masukkan reports ke sini agar tidak re-render peta
    ...
    const renderMarkers = (filterStatus: string) => {
        ...
        reports.forEach((report) => {
            ...
            // Cek apakah pelapor sudah terverifikasi (Poin >= 50)
                ...
                <div class="w-56 font-sans bg-white">
                    ...
                    <div class="flex items-center justify-between mb-1">
                        <span class="text-[10px] text-slate-500 font-bold flex items-center">
                            Oleh: ${report.user.name} ${verifiedBadgeHTML}
                        </span>
    ...
    // Trigger render marker setiap kali filter atau data reports berubah
    useEffect(() => {
    ...
    return (
                ...
                <div className="flex justify-between items-center w-full animate-in fade-in slide-in-from-top-4 duration-500">
                    <div>
                        <h2 className="text-xl lg:text-2xl font-black text-slate-800 tracking-tight flex items-center gap-2">
                            ...
                            Peta Wilayah {namaWilayah}
                        </h2>
                        <p className="text-xs lg:text-sm text-slate-500 mt-1">
                            Pantau sebaran titik tumpukan sampah di wilayah
                            Anda.
                        </p>
                    </div>
                </div>
        ...
        >
            <Head title="Peta Wilayah Kaling" />
