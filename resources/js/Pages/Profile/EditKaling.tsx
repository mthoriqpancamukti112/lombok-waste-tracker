    ...
    return (
        ...
        >
            ...
            <div className="max-w-4xl mx-auto space-y-6 pb-12">
                ...
                <div className="bg-gradient-to-br from-indigo-600 to-violet-700 rounded-3xl p-1 shadow-lg border border-indigo-400 overflow-hidden relative">
                    ...
                    <form onSubmit={submit} className="p-6 lg:p-8 space-y-6">
                        ...
                        <div className="flex items-center justify-end pt-4 border-t border-slate-100 mt-4">
                            <button
                                type="submit"
                                disabled={processing}
                                className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold py-2.5 px-6 rounded-xl shadow-md disabled:opacity-50 transition-all duration-300 hover:-translate-y-0.5 active:translate-y-0 min-w-[200px] flex justify-center items-center"
                            >
                                {processing ? (
