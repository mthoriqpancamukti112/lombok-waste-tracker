    ...
    return (
        <GuestLayout>
            ...
            <div className="pt-10 px-8 pb-10">
                ...
                {status && (
                    <div className="mb-6 text-[13px] font-bold text-green-600 bg-green-50/50 p-4 rounded-2xl border border-green-100 flex items-center gap-2 tracking-tight">
                    ...
                    <div className="flex justify-between items-center px-1">
                        ...
                        {canResetPassword && (
                            <Link
                                ...
                                className="text-xs font-black text-slate-400 hover:text-slate-600 transition-all uppercase tracking-tighter"
                            >
                                LUPA SANDI?
                            </Link>
                        )}
