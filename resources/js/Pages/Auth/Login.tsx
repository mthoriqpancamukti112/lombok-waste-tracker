    ...
    return (
        <GuestLayout>
            ...
            <div className="pt-12 px-10 pb-12">
                ...
                {status && (
                    <div className="mb-8 text-[13px] font-bold text-green-600 bg-green-50/50 p-4 rounded-2xl border border-green-100 flex items-center gap-2 tracking-tight">
                ...
                <form onSubmit={submit} className="space-y-6">
                    <div className="space-y-3">
                        <label className="text-lg font-bold text-slate-700 ml-1">Username</label>
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-50 border-2 border-transparent focus:border-[#a7e94a]/20 focus:bg-white focus:ring-4 focus:ring-[#a7e94a]/10 rounded-[24px] py-5 pl-12 pr-12 text-sm font-bold text-slate-700 placeholder-slate-400 transition-all duration-300"
                                required
                            />
                            <button
                                type="button"
                                onClick={() => setShowPassword(!showPassword)}
                                className="absolute right-5 top-1/2 -translate-y-1/2 text-slate-500 hover:text-slate-700 transition-colors"
                            >
                        ...
                        <label className="flex items-center gap-2.5 cursor-pointer group">
                            <div className="relative flex items-center justify-center">
                                <input
                                    ...
                                    className="peer w-5 h-5 rounded-lg border-2 border-slate-200 text-[#a7e94a] focus:ring-[#a7e94a]/20 transition-all cursor-pointer accent-[#a7e94a]"
                                />
                            </div>
                            <span className="text-sm font-bold text-slate-400 group-hover:text-slate-600 transition-colors">Keep me signed in</span>
                        </label>
                        {canResetPassword && (
                            <Link
                                href={route("password.request")}
                                className="text-xs font-black text-slate-400 hover:text-slate-800 transition-all uppercase tracking-tight"
                            >
                                Forgot Password?
                            </Link>
                        )}
